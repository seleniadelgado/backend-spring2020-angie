...
if (process.argv[2] === undefined || process.argv[2] === "list") {
    ...
    if (process.argv[3] <= 0) {
        console.log("Hey, use positive numbers, no such thing as a negative numbered 'to do' list! Thank you!");
    }
    if (process.argv[3] == null) {
        console.log("Hey, specify which note you want by typing the note's number!");
    }
    else {
